...
public class orderDao {
    public String addOrder(orderBean order){
        ...
        try{
            ...
            PreparedStatement pstmt = conn.prepareStatement("INSERT INTO REPAIR_JOB (DATESENDDEVICE,TRACKINGNUM,PROBLEM,STATUSID,SERIALNUM,CUSTID,STATUSDATE,PAYMENTID)"
                                                            +"VALUES(?,?,?,?,?,?,"
                                                            +"SELECT CURRENT_DATE(),"
