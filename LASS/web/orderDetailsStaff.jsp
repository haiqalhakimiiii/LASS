          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Update Order</button>
                </li>
                
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Assign Staff</button>
                </li>
...
String sql ="SELECT r.statusDate, s.statusDescription, r.jobID, c.custID, c.custName, c.custPhone, r.dateSendDevice, r.problem, r.trackingNum, t.staffID, t.staffName, r.serialNum, d.brand, d.model, p.totalPrice, p.deposit, p.datePayment FROM repair_job r JOIN status s ON r.statusID = s.statusID INNER JOIN device d ON r.serialNum = d.serialNum INNER JOIN staff t ON r.staffID = t.staffID INNER JOIN customer c ON r.custID = c.custID INNER JOIN payment p ON r.paymentID = p.paymentID WHERE r.jobID=3";
