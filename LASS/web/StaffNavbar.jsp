                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <%
                        try {
                            ...
                            String custPhone = (String) session.getAttribute("staffUsername");
                            String sql = "SELECT * FROM STAFF WHERE STAFFUSERNAME=" + custPhone;
                            resultSet = statement.executeQuery(sql);
                            int i = 0;
                            while (resultSet.next()) {
                    %>
                    <span class="d-none d-md-block dropdown-toggle ps-2"><%=resultSet.getString("STAFUSERNAME")%></span>
                    <%
                                i++;
                            }
                            connection.close();
